...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Machine Learning.", "Deep Learning.", "Software Developer."],    /* You can change the home section typing text from
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "Mount Mary Steps, Bandraw(West), Mumbai",  /* You can change your address from here */
            html: "<b>Address</b>: <br> Ashiana Apartments",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
